...
class _Matcher(_RequestHistoryTracker):
    def __init__(self, method: Any, url: Any, responses: Any, complete_qs: Any, request_headers: Any, additional_matcher: Any, real_http: Any, case_sensitive: Any, additional_matcher_kwargs: Any) -> None: ...
...
class Adapter(BaseAdapter, _RequestHistoryTracker):
    ...
    def register_uri(
        ...
        *,
        ...
        additional_matcher_kwargs: Optional[Dict[str, str]] = ...,
        **kwargs: Any
    ) -> Any: ...
